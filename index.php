...
<body class="no-select hide-scrollbar">
    ...
    <div class="container no-context-menu">
        ...
        <!-- Footer -->
        <div class="text-center" style="margin-top: 3rem; padding-top: 1.5rem; border-top: 1px solid var(--gray-200);">
            <p class="text-muted no-select" style="font-size: 0.875rem; margin-bottom: 0.5rem;">
